...
syn match cUserFunction "\<\h\w*\>\(\s\|\n\)*("me=e-1 contains=cType,cDelimiter,cDefine,cCustomParen
syn match cUserFunctionPointer "(\s*\*\s*\h\w*\s*)\(\s\|\n\)*(" contains=cDelimiter,cOperator,cCustomParen
...
hi def link cCustomParen SpecialKey
"hi def link cCustomFunc  Special
hi def link cUserFunction  Special
hi def link cUserFunctionPointer  Special
hi def link cCustomClass ModeMsg
hi def link cCustomScope Title

hi def link cBlock SpecialKey
