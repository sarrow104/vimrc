...
hi Normal	guifg=#BBBBBB guibg=grey17 gui=none
...
" add by sarrow
hi WideSpace	guibg=#553333
hi chTable	guibg=grey20	     guifg=grey17   gui=NONE
"hi chTable	guibg=#2a3c4c	     guifg=grey17   gui=NONE
hi TrilSpace	guifg=#332266 	     guibg=#332266  gui=italic,bold,underline
...
hi Number	guifg=#AA99EE	     gui=none
hi Character	guifg=pink	     gui=none
hi Constant	guifg=grey50	     gui=none
hi String	guifg=salmon         gui=none
